...
const QAS = [
    ...
    answer: (
      <>
        ...
        <p>
          ...
          ResumePilot saves time and prevents formatting mistakes by
  ...
  {
    question:
      "Q2. What uniquely sets ResumePilot apart from other resume builders and templates?",
    answer: (
      <>
        <p>
          Other than ResumePilot, there are some great free resume builders out
          there, e.g. <Link href="https://rxresu.me/">Reactive Resume</Link>,{" "}
          <Link href="https://flowcv.com/">FlowCV</Link>. However, ResumePilot
          stands out with 2 distinctive features:
        </p>{" "}
        <p>
          <span className="font-semibold">
            1. ResumePilot is designed specifically for the U.S. job market and
            best practices.
          </span>
          <br />
          Unlike other resume builders that target a global audience and offer
          many customization options, ResumePilot intentionally only offers
